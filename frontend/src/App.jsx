  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/admin/flights"   element={<RequireAuth roles={['admin']}><AdminFlightBookingsPage /></RequireAuth>} />
        <Route path="/admin/yachts"    element={<RequireAuth roles={['admin']}><AdminYachtChartersPage /></RequireAuth>} />
        <Route path="/admin/inquiries" element={<RequireAuth roles={['admin']}><AdminInquiriesPage /></RequireAuth>} />
        <Route path="/admin/users"     element={<RequireAuth roles={['admin']}><AdminUsersPage /></RequireAuth>} />
        <Route path="/admin/marketplace" element={<RequireAuth roles={['admin']}><AdminMarketplacePage /></RequireAuth>} />
        <Route path="/admin/emails"    element={<RequireAuth roles={['admin']}><AdminEmailLogsPage /></RequireAuth>} />
        <Route path="/admin/careers"   element={<RequireAuth roles={['admin']}><AdminCareersPage /></RequireAuth>} />
        <Route path="/admin/settings"  element={<RequireAuth roles={['admin']}><AdminSettingsPage /></RequireAuth>} />

        {/* ── Staff ──────────────────────────────────────────────────── */}
        <Route path="/staff" element={<RequireAuth roles={['admin','staff']}><StaffDashboardPage /></RequireAuth>} />
        <Route path="/staff/bookings"  element={<RequireAuth roles={['admin','staff']}><StaffBookingsPage /></RequireAuth>} />
        <Route path="/staff/inquiries" element={<RequireAuth roles={['admin','staff']}><StaffInquiriesPage /></RequireAuth>} />
        <Route path="/staff/email"     element={<RequireAuth roles={['admin','staff']}><StaffEmailPage /></RequireAuth>} />

        {/* ── Membership ─────────────────────────────────────────────── */}
        <Route path="/member" element={<RequireAuth roles={['client']}><MemberDashboardPage /></RequireAuth>} />
        <Route path="/member/book"     element={<RequireAuth roles={['client']}><MemberBookPage /></RequireAuth>} />
        <Route path="/member/fleet"    element={<RequireAuth roles={['client']}><MemberFleetPage /></RequireAuth>} />
        <Route path="/member/payments" element={<RequireAuth roles={['client']}><MemberPaymentsPage /></RequireAuth>} />
        <Route path="/member/profile"  element={<RequireAuth roles={['client']}><MemberProfilePage /></RequireAuth>} />
        <Route path="/member/routes"   element={<RequireAuth roles={['client']}><MemberRoutesPage /></RequireAuth>} />

        {/* ── Owner ──────────────────────────────────────────────────── */}
        <Route path="/owner" element={<RequireAuth roles={['owner']}><OwnerDashboardPage /></RequireAuth>} />
        <Route path="/owner/aircraft"    element={<RequireAuth roles={['owner']}><OwnerAircraftPage /></RequireAuth>} />
        <Route path="/owner/maintenance" element={<RequireAuth roles={['owner']}><OwnerMaintenancePage /></RequireAuth>} />
        <Route path="/owner/revenue"     element={<RequireAuth roles={['owner']}><OwnerRevenueePage /></RequireAuth>} />
